...
def contact():
    if request.method == 'POST':
        ...
        print(f"Name: {name} , Email: {email} , Message: {message}") #for now, just print it in terminal
...
@app.route('/thank-you')
def thank_you():
    return render_template('thank-you.html')  # Make sure the file name matches exactly
